/**
 * Button - A Tailwind UI Catalyst based Button Component
 *
 * Button component that supports multiple styles including solid, outlined, and plain.
 * Uses the `clsx` utility for conditional class names and supports forwarding refs.
 * Button is from the Tailwind UI Catalyst component library.
 *
